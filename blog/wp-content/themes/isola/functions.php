...
function isola_google_fonts() {
	...
	if ( 'off' !== _x( 'on', 'Source Sans Pro font: on or off', 'isola' ) ) {
		...
		wp_register_style( 'isola-source-sans-pro', "https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700,300italic,400italic,600italic,700italic&subset=latin,latin-ext" );
